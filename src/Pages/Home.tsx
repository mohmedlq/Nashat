        ...
        <section className="relative flex min-h-[760px] items-center py-24 lg:min-h-[820px]">
          ...
          <div className="relative mx-auto w-full max-w-5xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-[#98A19B] sm:text-lg">
              أنشئ الإذاعات والتقارير والمحتوى المدرسي، عدّلها كما تريد،
              واحصل على نسخة جاهزة للطباعة — كل ذلك من مكان واحد.
            </p>
                ...
                <div className="relative">
                  ...
                  <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                      ...
                      <p className="mt-3 max-w-xl text-sm leading-7 text-[#8F9992]">
                        بعض المشاريع والتجارب التي عملت عليها في تطوير الويب وبناء الأنظمة.
                      </p>
                    </div>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    {[
                      ...
                      },
                      {
                        name: "Swift Reports",
                        description:
                          "منصة تساعد المدارس على إنشاء تقارير النشاط وتنسيقها وتجهيزها للطباعة بسهولة.",
                        image: "/projects/swift-reports.png",
                        github: "https://github.com/",
                        badge: "ASP.NET Core · React",
                      },
                      {
                        name: "AI Prompt API",
                        description:
                          "واجهة برمجية لإنشاء المحتوى باستخدام نماذج الذكاء الاصطناعي وربطها بالتطبيقات.",
                        image: "/projects/ai-api.png",
                        github: "https://github.com/",
                        badge: "ASP.NET Core · AI",
                      },
                    ].map((project) => (
                      <article
                        key={project.name}
