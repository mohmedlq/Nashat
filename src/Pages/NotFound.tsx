  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-[-120px] bottom-1/4 h-72 w-72 rounded-full border border-[#29332D]/50" />
      </div>
      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-5 py-16 sm:px-8">
        <div className="w-full max-w-3xl text-center">
          ...
          <div className="relative mx-auto mb-8 w-fit">
            ...
            <h1 className="relative text-[120px] font-black leading-none tracking-[-0.08em] text-[#DCE3DD] sm:text-[160px]">
              404
            </h1>

            {/* Small Accent */}
            <div className="absolute -bottom-2 left-1/2 h-1 w-20 -translate-x-1/2 rounded-full bg-[#B39A63]" />
          </div>
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-8 text-[#929C95] sm:text-base">
            ...
            لكن لا تقلق، يمكنك العودة إلى المنصة ومتابعة إنشاء محتواك المدرسي.
          </p>
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href="/"
              className="group inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#DCE3DD] px-6 text-sm font-bold text-[#18211C] transition-all duration-200 hover:bg-white sm:w-auto"
            >
              <Home size={17} />
            ...
            <a
              href="/#generator"
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-[#354039] bg-[#171E1A] px-6 text-sm font-semibold text-[#D4D9D5] transition-all duration-200 hover:border-[#4A574F] hover:bg-[#1B241F] sm:w-auto"
            >
              <Sparkles size={17} />
